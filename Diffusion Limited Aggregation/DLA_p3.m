...
for i = 1:nParticles
    ...
    while 1
        ...
        if (A(xL, y) > 0 && A(xR, y) > 0) || (A(x, yU) > 0 && A(x, yD) > 0) || (A(xL, y) > 0 && A(x, yD) > 0) || (A(x, yU) > 0 && A(xL, y) > 0) || (A(xR, y) > 0 && A(x, yD) > 0) || (A(xR, y) > 0 && A(x, yU) > 0)
           n = n + 1;
        end
        if A(xL, y) > 0 && A(xR, y) > 0 && A(x, yD) > 0 || (A(xL, y) > 0 && A(xR, y) > 0 && A(x, yU) > 0) || (A(xL, y) > 0 && A(x, yD) > 0 && A(x, yU) > 0) || (A(x, yU) > 0 && A(xR, y) > 0 && A(x, yD) > 0)
           n = n + 1;
        end
        if A(x, yU) > 0 && A(xL, y) > 0 && A(xR, y) > 0 && A(x, yD) > 0 
            n = n + 1;
        end
        if n == 1
           p = 1*p;
